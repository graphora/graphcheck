...
FIXTURE_ROOT = ROOT / "tests" / "fixtures" / "external" / "fraud-ring"
...
OUTPUTS = {
    "findings": ROOT / "docs" / "samples" / "reports" / "report-findings.html",
    "clean": ROOT / "docs" / "samples" / "reports" / "report-clean.html",
}
...
def verify_fixture_checkout(*, git_output: Callable[..., str] = _git_output) -> dict[str, Any]:
    gitlink = git_output("rev-parse", ":tests/fixtures/external/fraud-ring", cwd=ROOT)
