...
`tests/generation/test_transmission.py`

- builds the exact expected allow-listed object from `tests/contracts/fixtures/baseline.json`;
...
`tests/generation/test_documents.py`
...
`tests/generation/test_proposals.py`
...
`tests/generation/test_client.py`
...
1. Copy `tests/contracts/fixtures/baseline.json` into a temporary project's baseline directory.
