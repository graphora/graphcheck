...
See [SPEC-02](../specifications/spec-02-check-yaml.md) for the full check YAML contract, and
[SPEC-09](../specifications/spec-09-packs.md) for how built-in packs are registered and validated.
