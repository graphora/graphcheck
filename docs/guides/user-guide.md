...
Cypher 5 sampling path are documented in the [compatibility matrix](../reference/compatibility.md).
...
[SPEC-04](../specifications/spec-04-engine.md#baselines) for the accepted baseline shapes and resolution
rules.
...
behavior. See [the telemetry disclosure](../reference/telemetry.md) for the complete event and field
inventory.
...
The complete frozen contracts and generated schemas live in
[`docs/specifications`](../specifications/):

- [SPEC-01 — results.json](../specifications/spec-01-results-json.md)
- [SPEC-02 — check YAML](../specifications/spec-02-check-yaml.md)
- [SPEC-03 — Neo4j connector](../specifications/spec-03-connector.md)
- [SPEC-04 — engine and CLI](../specifications/spec-04-engine.md)
- [SPEC-09 — built-in packs](../specifications/spec-09-packs.md)
