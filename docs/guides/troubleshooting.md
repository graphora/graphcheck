...
- See [CI setup](github-actions.md) for how these map onto exit codes in a pipeline, and
  [Check reference](../reference/checks.md) for check-specific `catches`/`does not catch` behavior.
