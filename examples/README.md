...
Files named `profiles.example.yml` are safe templates. Copy one to the ignored `profiles.yml`
filename and supply credentials that are appropriate for your own environment.
